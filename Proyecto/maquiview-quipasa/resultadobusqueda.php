...
<body>
	...
	<div class="row">
		<!-- 5 Top Button -->
		<div class="col-md-4 text-center" style="left:100px;">
		...
		<div class="col-md-4 text-center" style="right:100px;">
			<form action="recomendaciones.php" style="width:40%; margin:0 auto; margin-top:20px;">	
				<button type="submit" class="btn btn-success btn-lg">Recomendaciones</button>
			</form>
		</div>
	</div>
	<hr>
